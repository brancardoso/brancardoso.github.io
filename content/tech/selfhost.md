...
* [lidarr](https://github.com/Lidarr/Lidarr) - music organization/manager
...
* [jellyfin](https://github.com/jellyfin/jellyfin) - media system backend and web api, video streaming
...
* [profilarr](https://github.com/Dictionarry-Hub/Profilarr/) - manage quality configs for radarr, sonarr, lidarr
...
class MaM,AZ,AnZ,CZ,OE,BLU,LST acq;
